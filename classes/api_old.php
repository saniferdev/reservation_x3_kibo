...
Class API{
    ...
    public function entete($client,$pro_num,$adresse,$tel,$email,$id){
        $mode_paiement  =   $this->getOrderPaiement($id);
        $reference      =   $this->getReference($id);
        $compte_pro     =   (isset($pro_num) && !empty($pro_num)) ? $pro_num : 'P01K0001';
        ...
        while ($iterator->valid()) {
            if ($iterator->hasChildren()) {
                foreach ($iterator->getChildren() as $value) {
                    if($value["pro_num"][0]) $pro_num = $value["pro_num"][0];
                        ...
                        //if($this->insertId($value["id"]) == TRUE){
                            ...
                            foreach ($detail as $key => $article) {
                                        if(isset($article['article'])){
                                            ...
                                            if($i == 0){
                                                ...
                                                $entete   = $this->entete($exp[2],$exp[4],$exp[5],$exp[6],$exp[3],$value["id"]);
                                                $ligne    = '<TAB ID="IND">';
                                                $xml_Ref .= '<TAB ID="IND">';
                            ...
                            if(isset($entete) && isset($ligne)){
                                ...
                                if(isset($commande) && !empty($commande)) {
                                    ...
                                    $adresse = "Dominique.leong@talys.mg";
